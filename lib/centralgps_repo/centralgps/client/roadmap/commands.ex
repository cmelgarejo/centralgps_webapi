defmodule CentralGPS.Repo.Client.Roadmap.Commands do
  ...
  def cmd_fn_api_roadmap_create,
    do: "SELECT * FROM client.fn_api_roadmap_create($1, $2, $3, $4, $5::jsonb, $6, $7, $8, $9::timestamp without time zone, $10::char, $11::integer[], $12::integer[], $13::integer[], $14::integer, $15::time, $16::time, $17::boolean, $18::boolean, $19::jsonb);"
  ...
  def cmd_fn_api_roadmap_update,
    do: "SELECT * FROM client.fn_api_roadmap_update($1, $2, $3, $4, $5::jsonb, $6::bigint, $7, $8, $9, $10::timestamp without time zone, $11::char, $12::integer[], $13::integer[], $14::integer[], $15::integer, $16::time, $17::time, $18::boolean, $19::boolean, $20::jsonb);"
