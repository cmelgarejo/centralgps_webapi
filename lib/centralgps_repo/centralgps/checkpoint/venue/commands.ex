defmodule CentralGPS.Repo.Checkpoint.Venue.Commands do
  ...
  #Input JSON: [ :venue_code, :venue_configuration_id, :venue_description, :venue_detection_radius, :venue_image, :venue_lat, :venue_lon, :venue_name, :venue_type_id, :venue_xtra_info ]
  def cmd_fn_api_venue_create,
    do: "SELECT * FROM checkpoint.fn_api_venue_create($1, $2, $3, $4, $5::jsonb, $6, $7::bigint, $8, $9::integer, $10, $11::double precision, $12::double precision, $13, $14::bigint, $15::jsonb);"
  ...
  #Input JSON: [ :venue_code, :venue_configuration_id, :venue_description, :venue_detection_radius, :venue_id, :venue_image, :venue_lat, :venue_lon, :venue_name, :venue_type_id, :venue_xtra_info ]
  def cmd_fn_api_venue_update,
    do: "SELECT * FROM checkpoint.fn_api_venue_update($1, $2, $3, $4, $5::jsonb, $6, $7::bigint, $8, $9::integer, $10::bigint, $11, $12::double precision, $13::double precision, $14, $15::bigint, $16::jsonb);"
  ...
  def cmd_fn_api_venue_list,
    do: "SELECT * FROM checkpoint.fn_api_venue_list($1, $2, $3, $4, $5::jsonb, $6::bigint, $7::bigint, $8::, $9::, $10::, $11::text);"
