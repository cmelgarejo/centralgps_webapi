defmodule CentralGPS.Repo.Checkpoint.Venue.Commands do
  ...
  def cmd_fn_api_venue_create,
    do: "SELECT * FROM checkpoint.fn_api_venue_create($1, $2, $3, $4, $5::jsonb, $6::bigint, $7::bigint, $8, $9, $10, $12, $13::double precision, $14::double precision, $13::double precision, $14::integer, $15::jsonb);"
