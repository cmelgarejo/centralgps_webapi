defmodule CentralGPS.Repo.Checkpoint.Venue.Commands do
  ...
  def cmd_fn_api_venue_create,
    do: "SELECT * FROM checkpoint.fn_api_venue_create($1, $2, $3, $4, $5::jsonb, $6::bigint, $7::bigint, $8:bigint, $9, $10, $11, $12, $13, $14::double precision, $15::double precision, $16::integer, $17::boolean, $18::jsonb);"
  ...
  def cmd_fn_api_venue_update,
    do: "SELECT * FROM checkpoint.fn_api_venue_update($1, $2, $3, $4, $5::jsonb, $6::bigint, $7::bigint, $8::bigint, $9:bigint, $10, $11, $12, $13, $14, $15::double precision, $16::double precision, $17::integer, $18::boolean, $19::jsonb);"
