defmodule CentralGPS.Repo.Checkpoint.Client.Commands do
  ...
  def cmd_fn_api_client_create,
    do: "SELECT * FROM checkpoint.fn_api_client_create($1, $2, $3, $4, $5::jsonb, $6::bigint, $7, $8, $9, $10::jsonb);"
  ...
  def cmd_fn_api_client_update,
    do: "SELECT * FROM checkpoint.fn_api_client_update($1, $2, $3, $4, $5::jsonb, $6::bigint, $7::bigint, $8, $9, $10, $11::jsonb);"
