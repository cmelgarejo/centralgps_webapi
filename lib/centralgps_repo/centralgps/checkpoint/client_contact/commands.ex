defmodule CentralGPS.Repo.Checkpoint.ClientContact.Commands do
  ...
  def cmd_fn_api_client_contact_create,
    do: "SELECT * FROM checkpoint.fn_api_client_contact_create($1, $2, $3, $4, $5::jsonb, $6::bigint, $7, $8, $9, $10, $11::boolean);"
  ...
  def cmd_fn_api_client_contact_update,
    do: "SELECT * FROM checkpoint.fn_api_client_contact_update($1, $2, $3, $4, $5::jsonb, $6::bigint, $7::bigint, $8, $9, $10, $11, $12::boolean);"
  ...
  #DB Definition: checkpoint.fn_api_client_contact_list (_auth_token, _auth_type, _the_app_name, _the_ip_port, _xtra_info, _offset, _limit, search_column, search_phrase) RETURNS common.return_type_json_list
  def cmd_fn_api_client_contact_list,
    do: "SELECT * FROM checkpoint.fn_api_client_contact_list($1, $2, $3, $4, $5::jsonb, $6::bigint, $7::bigint, $8::text, $9::text, $10::text, $11::text);"
