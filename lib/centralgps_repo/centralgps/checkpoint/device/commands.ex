defmodule CentralGPS.Repo.Checkpoint.Device.Commands do
  ...
  def cmd_fn_chkapi_record,
    do: "SELECT * FROM checkpoint.fn_chkapi_record($1::text, $2::text, $3::double precision, $4::bigint, $5::text, $6::double precision, $7::double precision,$8::text,$9::double precision,$10::double precision,$11::boolean,$12::timestamp without time zone,$13::bigint, $14::double precision, $15, $16::bigint, $17::jsonb);"
