defmodule CentralGPS.Repo.Checkpoint.VenueType.Commands do
  ...
  #Input JSON: [ :venue_type_configuration_id, :venue_type_description, :venue_type_image ]
  ...
  #DB Definition: checkpoint.fn_api_venue_type_create (_auth_token text, _auth_type, _the_app_name, _the_ip_port, _xtra_info, venue_type_configuration_id, venue_type_description, venue_type_id, venue_type_image) RETURNS common.return_type_generic
  #Input JSON: [ :venue_type_configuration_id, :venue_type_description, :venue_type_id, :venue_type_image]
  def cmd_fn_api_venue_type_update,
    do: "SELECT * FROM checkpoint.fn_api_venue_type_update($1, $2, $3, $4, $5::jsonb, $6::bigint, $7, $8::bigint, $9);"
