defmodule CentralGPS.Repo.Checkpoint.Item.Commands do
  ...
  def cmd_fn_api_item_create,
    do: "SELECT * FROM checkpoint.fn_api_item_create($1, $2, $3, $4, $5::jsonb, $6::bigint, $7, $8, $9, $10::double precision, $11::double precision, $12::double precision);"
  ...
  def cmd_fn_api_item_update,
    do: "SELECT * FROM checkpoint.fn_api_item_update($1, $2, $3, $4, $5::jsonb, $6::bigint, $7::bigint, $8, $9, $10, $11::double precision, $12::double precision, $13::double precision);"
