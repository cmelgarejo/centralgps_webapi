defmodule CentralGPS.Repo.Checkpoint.Activity.Commands do
  ...
  #DB Definition: checkpoint.fn_api_activity_create (_auth_token text, _auth_type, _the_app_name, _the_ip_port, _xtra_info, activity_id, activity_configuration_id, activity_description) RETURNS common.return_type_generic
  ...
  #DB Definition: checkpoint.fn_api_activity_delete (_auth_token text, _auth_type, _the_app_name text, _the_ip_port text, _xtra_info, activity_id) RETURNS common.return_type_generic
  #Input JSON: [ :activity_id,]
