defmodule CentralGPS.Repo.Security.Account.Commands do
  ...
  #DB Definition: security.fn_api_account_active (_auth_token, _auth_type, _the_app_name, _the_ip_port, _xtra_info account_id account_type, set_active boolean) RETURNS common.return_type_generic
  ...
  #DB Definition: security.fn_api_account_create (_auth_token, _auth_type, _the_app_name, _the_ip_port, _xtra_info, account_type, client_id, user__login_name, user__login_password, user_dob, user_identity_document, user_info_emails, user_info_phones, user_language_template_id, user_name, user_profile_image_path, user_profile_image_bin, user_timezone, user_xtra_info)
  #Input JSON: [ "_auth_token", :_auth_type, "account_type", "client_id", "user__login_name", "user__login_password", "user_dob", "user_identity_document", "user_info_emails", "user_info_phones", "user_language_template_id", "user_name", "user_profile_image_path", "user_profile_image_bin", "user_timezone", "user_xtra_info" ]
  def cmd_fn_api_account_create,
    do: "SELECT * FROM security.fn_api_account_create($1, $2, $3, $4, $5::jsonb, $6, $7::bigint, $8, $9, $10::date, $11, $12, $13, $14::bigint, $15, $16, $17::bytea, $18::real, $19::jsonb);"

  #DB Definition: security.fn_api_account_read (_auth_token, _auth_type, _the_app_name, _the_ip_port, _xtra_info account_id account_type,) RETURNS common.return_type_json_result
  ...
  #DB Definition: security.fn_api_account_update (_auth_token, _auth_type, _the_app_name, _the_ip_port, _xtra_info, account_id, account_type, user__login_password, user_dob, user_identity_document, user_info_emails, user_info_phones, user_language_template_id, user_name, user_profile_image_path, user_profile_image_bin, user_timezone real, user_xtra_info)
  #Input JSON: [ "_auth_token", :_auth_type, "_the_app_name", "_the_ip_port", "_xtra_info", "account_id", "account_type", "user__login_password", "user_dob", "user_identity_document", "user_info_emails", "user_info_phones", "user_language_template_id", "user_name", "user_image_path", "user_image_bin", "user_timezone", "user_xtra_info" ]
  def cmd_fn_api_account_update,
    do: "SELECT * FROM security.fn_api_account_update($1, $2, $3, $4, $5::jsonb, $6::bigint, $7, $8, $9::date, $10, $11, $12, $13::bigint, $14, $15, $16::bytea, $17::real, $18::jsonb);"

  #DB Definition: security.fn_api_account_delete (_auth_token, _auth_type, _the_app_name, _the_ip_port, _xtra_info account_id account_type,) RETURNS common.return_type_generic
  #Input JSON: [ "_auth_token", :_auth_type, "account_id", "account_type" ]
  ...
  #DB Definition: security.fn_api_account_role_create (_auth_token, _auth_type, _the_app_name, _the_ip_port, _xtra_info account_id account_type, role_id) RETURNS common.return_type_generic
  ...
  #DB Definition: security.fn_api_account_role_delete (_auth_token, _auth_type, _the_app_name, _the_ip_port, _xtra_info account_id account_type, role_id) RETURNS common.return_type_generic
  #Input JSON: [ "_auth_token", :_auth_type, "account_id", "account_type", "role_id" ]
