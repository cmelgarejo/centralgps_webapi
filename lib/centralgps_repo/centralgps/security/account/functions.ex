defmodule CentralGPS.Repo.Security.Account.Functions do
  ...
  def fn_api_logout(params, filter_keys \\ []) do
    {row_count, result} = query(cmd_fn_api_logout, params, filter_keys)
    {row_count, hd(result)}
  end
  ...
  def fn_api_account_permission_check(params, filter_keys \\ []) do
    {row_count, result} = query(cmd_fn_api_account_permission_check, params, filter_keys)
    {row_count, hd(result)}
  end
