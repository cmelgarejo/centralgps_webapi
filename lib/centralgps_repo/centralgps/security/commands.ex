defmodule CentralGPS.Repo.Security.Commands do
  #DB Definition: security.fn_api_login (_login_user, _password, _auth_type char, _session_status boolean, _the_app_name, _the_ip_port, _xtra_info jsonb) RETURNS security.record_type_login
  ...
  #DB Definition: security.fn_api_account_active (_auth_token, _auth_type, _the_app_name, _the_ip_port, _xtra_info jsonb account_id bigint account_type, set_active boolean) RETURNS common.return_type_generic
  ...
  #DB Definition: security.fn_api_account_create (_auth_token, _auth_type, _the_app_name, _the_ip_port, _xtra_info jsonb account_type, user__login_name, user__login_password, user_dob date user_identity_document, user_info_emails, user_info_phones, user_language_template_id bigint user_name, user_profile_image, user_timezone real user_xtra_info jsonb)	RETURNS common.return_type_generic
  ...
  #DB Definition: security.fn_api_account_read (_auth_token, _auth_type, _the_app_name, _the_ip_port, _xtra_info jsonb account_id bigint account_type,) RETURNS common.return_type_json_result
  ...
  #DB Definition: security.fn_api_account_update (_auth_token, _auth_type, _the_app_name, _the_ip_port, _xtra_info jsonb account_id bigint account_type, user__login_password, user_dob date user_identity_document, user_info_emails, user_info_phones, user_language_template_id bigint user_name, user_profile_image, user_timezone real user_xtra_info jsonb) RETURNS common.return_type_generic
  ...
  #DB Definition: security.fn_api_account_delete (_auth_token, _auth_type, _the_app_name, _the_ip_port, _xtra_info jsonb account_id bigint account_type,) RETURNS common.return_type_generic
  #Input JSON: [ "_auth_token", "_auth_type", "account_id", "account_type" ]
  def cmd_fn_api_account_delete,
    do: "SELECT * FROM security.fn_api_account_delete($1, $2, $3, $4, $5::jsonb, $6::bigint, $7);"

  #DB Definition: security.fn_api_account_list (_auth_token, _auth_type, _the_account_type, _the_app_name, _the_ip_port, _xtra_info jsonb) RETURNS common.return_type_json_list
  ...
  #DB Definition: security.fn_api_account_role_create (_auth_token, _auth_type, _the_app_name, _the_ip_port, _xtra_info jsonb account_id bigint account_type, role_id bigint) RETURNS common.return_type_generic
  ...
  #DB Definition: security.fn_api_account_role_delete (_auth_token, _auth_type, _the_app_name, _the_ip_port, _xtra_info jsonb account_id bigint account_type, role_id bigint) RETURNS common.return_type_generic
  #Input JSON: [ "_auth_token", "_auth_type", "account_id", "account_type", "role_id" ]
