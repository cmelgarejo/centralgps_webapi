  ...
  scope "/api/v1/client/asset", CentralGPSWebAPI.Controllers do
    ...
    get     "/",          Client.Asset, :asset_list #placeholder, should be :list

    #CRUD AssetRoadmap
    post    "/:asset_id/roadmap/:roadmap_id/create", Client.AssetRoadmap, :create
  ...
  scope "/api/v1/client/roadmap", CentralGPSWebAPI.Controllers do
    ...
    #CRUD AssetRoadmap
    post    "/:roadmap_id/asset/:asset_id/create", Client.AssetRoadmap, :create
  ...
  scope "/api/v1/client/roadmap/:roadmap_id/point", CentralGPSWebAPI.Controllers do
    ...
    put     "/:roadmap_point_id/:roadmap_point_order", Client.RoadmapPoint, :update_point_order
  ...
  scope "/api/v1/checkpoint", CentralGPSWebAPI.Controllers do
    pipe_through :api
      ...
      get     "/form_template/:form_template_id",               Checkpoint.FormTemplate, :read
      put     "/form_template/:form_template_id",               Checkpoint.FormTemplate, :update
      delete  "/form_template/:form_template_id/:remove_items", Checkpoint.FormTemplate, :delete
      ...
      get     "/activity/:form_id/:activity_id", Checkpoint.Activity, :read
