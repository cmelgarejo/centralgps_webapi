defmodule CentralGPSWebAPI.Controllers.Device.Record do
  ...
  def record(conn, params) do
    try do
      keys = [ :lat, :lon, :speed, :bearing, :accuracy, :altitude, :status, :address, :position_at, :xtra_info ]
      ...
      params = params
        ...
        |> (Map.put :ip_port, ip)
      {_, result} = fn_chkapi_record ([ params._auth_token, params.lat, params.lon, params.speed,
