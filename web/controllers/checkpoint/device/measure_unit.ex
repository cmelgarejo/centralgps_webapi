defmodule CentralGPSWebAPI.Controllers.Device.MeasureUnits do
  use CentralGPSWebAPI.Web, :controller
  import CentralGPS.Repo.Utilities
  import CentralGPS.Repo.Checkpoint.Device.Functions

  def measure_units(conn, params) do
    try do
  ...
  def measure_units_update(conn, params) do
    try do
      _k = [ :_sync_token ]
