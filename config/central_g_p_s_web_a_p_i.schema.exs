[
  mappings: [
    "central_g_p_s_web_a_p_i.Elixir.CentralGPSWebAPI.Endpoint.url.host": [
      doc: "Provide documentation for central_g_p_s_web_a_p_i.Elixir.CentralGPSWebAPI.Endpoint.url.host here.",
      to: "central_g_p_s_web_a_p_i.Elixir.CentralGPSWebAPI.Endpoint.url.host",
      datatype: :binary,
      default: "api.centralgps.net"
    ],
